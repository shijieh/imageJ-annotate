...
This repository contains codes used to (1)automate the ImageJ cell counting (*auto_run.ijm*) and (2) visualize the cell counter results with manual clicking (*annotate.ipynb*)
